...
void lab_code() {
    ...
    /* solution : set rax=191 use gadget1 and gadget4 to control rdx=1337
    use gadget3 to 0 rdi and use gadget5 2 times set rdi=2
    use gadget3 to 0 rdi and use gadget5 4 and use gadget 6 to mov rsi,rdi
    */
